...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CalendarDateRangePicker/CalendarDateRangePicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LimberTabbar/LimberTabbar.framework"
